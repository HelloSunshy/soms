        ...
        <div class="col-md-12 column">
            <form class="form-horizontal" role="form">
                ...
                <div>
                    ...
                    <h1 style="margin-left:10%">学生信息确认</h1>
                ...
                <div class="col-md-12 column" style="margin-left:6%;margin-top:10px" >
                    <button type="button" class="btn btn-success btn-default active" style="margin-left:60px"><a href="/soms/user/toindex" style="color: white">确认</a></button>

                    <button type="button" class="btn btn-default active btn-danger" style="margin-left:20%"><a href="/soms/user/callerror" style="color: white">报错</a></button>
