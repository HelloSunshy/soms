        ...
        <div class="col-md-12 column">
            <table class="table table-hover table-bordered table-condensed">
                ...
                <tr>
                    ...
                    <c:forEach var="doctor" items="${doctorlist}" end="${hlr}">
                    ...
                    <c:if test="${master.orderStatus==1}">
                        <td ><a style="color: red" href="/soms/user/cancel?orderMasterId=${master.orderMasterId}">取消</a></td>
                    </c:if>
                </tr>
                </c:forEach>
